...
def test_nemotron_chat():
    """Test Nemotron chat completion (non-streaming)."""
    print("=" * 60)
    ...
    start = time.time()
    try:
        reply = llm.chat(prompt=prompt, system=system, temperature=0.6, max_tokens=512)
...
def test_nemotron_stream():
    """Test Nemotron streaming completion."""
    print("=" * 60)
